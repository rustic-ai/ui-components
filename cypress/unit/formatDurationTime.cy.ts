...
describe('formatDurationTime', () => {
  it('it should show 3 digits if the duration is less than 10 seconds', () => {
  ...
  it('it should show 3 digits if the duration is between is less than 10 minutes', () => {
    // 1 minute
  ...
  it('it should show 5 digits if the duration is between is less than 10 hours', () => {
    // 1 hour
