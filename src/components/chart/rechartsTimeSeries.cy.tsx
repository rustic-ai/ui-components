...
describe('TimeSeries', () => {
  ...
  it('should toggle chart types via the menu', () => {
  ...
  it('displays title, description, and reference line if provided', () => {
  ...
  it('should show a single line in the chart when clicking on a legend item', () => {
  ...
  it('can show two selected lines in the chart when clicking on two legend items', () => {
  ...
  it('can hide the chart type toggle and only show the default chart type', () => {
    cy.mount(
      <RechartsTimeSeries
        timeSeries={timeSeries}
        title="title"
