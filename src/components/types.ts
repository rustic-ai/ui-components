...
export interface TimeSeriesFormat extends DataFormat {
  ...
  updatedData?: { timeSeries: TimeSeriesDataset[] }[]
  ...
  /** Spacing around chart container in pixel. Depending on the charting library, this pros could be used to add padding or margin*/
